...
//
// Since Geth does not tolerate complex EIP-712 type names, this normalizes the
// inputs into a compatible form.
// audit:B5: compatibility normalization helper reviewed in audit/B5_RISK_MARKER_REVIEW.md.
