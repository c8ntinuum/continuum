...
contract EIP712Proxy is Semver, EIP712 {
    ...
    constructor() Semver(1, 4, 0) EIP712("C8ntinuum AttesterProxy", "1.4.0") {
        _eas = IEAS(0x4200000000000000000000000000000000000021);
        _name = "C8ntinuum AttesterProxy";
    }
    ...
    function multiAttestByDelegation(
        ...
        MultiAttestationRequest[]
            memory multiRequests = new MultiAttestationRequest[](length);
    ...
    function multiRevokeByDelegation(
        ...
        uint256 length = multiDelegatedRequests.length;
        MultiRevocationRequest[]
            memory multiRequests = new MultiRevocationRequest[](length);
    ...
    function _verifyAttest(
        ...
        if (
            request.deadline != NO_EXPIRATION_TIME && request.deadline < _time()
        ) {
