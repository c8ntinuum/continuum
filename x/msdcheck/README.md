...
This module enforces a minimum stake requirement for validator creation and updates across **all** transaction entry points (Cosmos SDK txs, API, EVM precompile).
...
4. `MsgEditValidator` below minimum stake — **reject**
5. EVM staking precompile `createValidator` below minimum — **reject**
6. EVM staking precompile `createValidator` at exact minimum — **accept**
7. EVM staking precompile `createValidator` above minimum — **accept**
