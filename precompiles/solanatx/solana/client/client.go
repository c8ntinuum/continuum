...
import (
	...
	"github.com/cosmos/evm/precompiles/solanatx/solana/types"
)
...
func NewClientWithApiKey(endpoint, headerApiKey, apiKey string) *Client {
	return &Client{rpc.New(rpc.WithEndpointAndApiKey(endpoint, headerApiKey, apiKey))}
}
