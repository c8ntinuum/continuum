...
/// @dev The AddressTable contract's address.
address constant ADDRESS_TABLE_PRECOMPILE_ADDRESS = 0x0000000000000000000000000000000000000710;

/// @dev The AddressTable contract's instance.
AddressTableI constant ADDRESS_TABLE_CONTRACT = AddressTableI(
    ADDRESS_TABLE_PRECOMPILE_ADDRESS
);

/**
 * @title Allows registering / retrieving addresses at uint indices, saving calldata.
 * @notice Precompiled contract that exists at 0x0000000000000000000000000000000000000710.
 */
interface AddressTableI {
    /**
