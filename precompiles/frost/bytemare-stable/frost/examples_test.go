...
func Example_signer() {
	...
	// e.g. from github.com/cosmos/evm/precompiles/frost/bytemare-stable/dkg, which is compatible with FROST.
...
func Example_key_generation_decentralised() {
	fmt.Println("Visit github.com/cosmos/evm/precompiles/frost/bytemare-stable/dkg for an example and documentation.")
	// Output: Visit github.com/cosmos/evm/precompiles/frost/bytemare-stable/dkg for an example and documentation.
}
