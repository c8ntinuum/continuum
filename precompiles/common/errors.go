...
const (
	...
	// ErrInvalidValidatorOperator is raised when the validator operator address is not valid.
	ErrInvalidValidatorOperator = "invalid validator operator address: %s"
	...
	// ErrInvalidArgument
	ErrInvalidArgument = "invalid argument: arg: %s - val: %v"
	// ErrInsufficientRewardsBalance
	ErrInsufficientRewardsBalance = "insufficient rewards balance"
	// ErrNoOutstandingBalance
	ErrNoOutstandingBalance = "no outstanding balance"
)
