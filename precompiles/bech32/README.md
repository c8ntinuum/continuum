...
The precompile charges `6000` base gas plus `3` gas for each additional 32-byte word of calldata.
This keeps longer strings from being underpriced relative to their parsing cost.
...
- Prefixes longer than 32 bytes are rejected
...
- Addresses longer than 128 characters are rejected before decoding
