...
func SetupWithGenesisValSet(t *testing.T, chainID string, evmChainID uint64, valSet *cmttypes.ValidatorSet, genAccs []authtypes.GenesisAccount, balances ...banktypes.Balance) *EVMD {
	...
	require.NoError(t, err)
	bankGenesis.DenomMetadata = []banktypes.Metadata{defaultDenomMetadata(types.DefaultEVMExtendedDenom)}
...
func defaultDenomMetadata(denom string) banktypes.Metadata {
	return banktypes.Metadata{
		Description: "Native 18-decimal denom metadata for ctmd test app",
		Base:        denom,
