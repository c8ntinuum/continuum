...
import (
	...
	"github.com/cosmos/evm/x/feeburn"
	feeburnkeeper "github.com/cosmos/evm/x/feeburn/keeper"
	feeburntypes "github.com/cosmos/evm/x/feeburn/types"
	"github.com/cosmos/evm/x/feemarket"
	feemarketkeeper "github.com/cosmos/evm/x/feemarket/keeper"
	feemarkettypes "github.com/cosmos/evm/x/feemarket/types"
	ibccallbackskeeper "github.com/cosmos/evm/x/ibc/callbacks/keeper"

	circuit "github.com/cosmos/evm/x/circuit"
	...
	ibcbreaker "github.com/cosmos/evm/x/ibcbreaker"
...
type EVMD struct {
	*baseapp.BaseApp
	...
	IbcBreakerKeeper        ibcbreakerkeeper.Keeper
	IbcRateLimiterExtKeeper ibcratelimiterextkeeper.Keeper
...
func NewExampleApp(
	...
	kvStoreKeys := []string{
		...
		valrewardstypes.StoreKey, circuittype.StoreKey, ibcbreakertypes.StoreKey, ibcratelimiterexttypes.StoreKey,
	}
	kvStoreKeys = append(kvStoreKeys, optionalRateLimitStoreKeys()...)
	keys := storetypes.NewKVStoreKeys(kvStoreKeys...)
	...
	invCheckPeriod := cast.ToUint(appOpts.Get(sdkserver.FlagInvCheckPeriod))
	...
	*/
	...
	precisebankkeeper.RegisterInvariants(app.CrisisKeeper, &app.PreciseBankKeeper)
	feeBurnKeeper := feeburnkeeper.NewKeeper(app.AccountKeeper, app.BankKeeper, app.PreciseBankKeeper)
	...
	app.CircuitKeeper = circuitkeeper.NewKeeper(
		appCodec,
		keys[circuittype.StoreKey],
		authtypes.NewModuleAddress(govtypes.ModuleName),
	)
	app.IbcBreakerKeeper = ibcbreakerkeeper.NewKeeper(
		appCodec,
		keys[ibcbreakertypes.StoreKey],
		authtypes.NewModuleAddress(govtypes.ModuleName),
	)
	app.IbcRateLimiterExtKeeper = ibcratelimiterextkeeper.NewKeeper(
		appCodec,
		keys[ibcratelimiterexttypes.StoreKey],
		authtypes.NewModuleAddress(govtypes.ModuleName),
	)
	...
	/*
		...
		transfer stack contains (from bottom to top):
			...
			- ERC-20 Middleware
			- IBC Transfer
			- IBC Rate-Limiting Middleware

		SendPacket, since it is originating from the application to core IBC:
		 	transferKeeper.SendPacket -> erc20.SendPacket -> callbacks.SendPacket -> ratelimiting.SendPacket -> channel.SendPacket

		RecvPacket, message that originates from core IBC and goes down to app, the flow is the other way
			channel.RecvPacket -> ratelimiting.OnRecvPacket -> callbacks.OnRecvPacket -> erc20.OnRecvPacket -> transfer.OnRecvPacket
	*/
	...
	transferStack, transferStackV2, rateLimitAppModule := setupOptionalRateLimit(
		app,
		appCodec,
		keys,
		authAddr,
	...
	appModules := []module.AppModule{
		...
		feeburn.NewAppModule(feeBurnKeeper),
		msdcheck.NewAppModule(appCodec, app.StakingKeeper, app.AccountKeeper, app.BankKeeper, nil),
	...
	if rateLimitAppModule != nil {
		appModules = append(appModules, rateLimitAppModule)
	}
	...
	appModules = append(appModules,
		...
		ibcbreaker.NewAppModule(app.IbcBreakerKeeper),
		ibcratelimiterext.NewAppModule(app.IbcRateLimiterExtKeeper),
	...
	app.BasicModuleManager = module.NewBasicManagerFromManager(
		...
		map[string]module.AppModuleBasic{
			...
			circuittype.ModuleName:      circuit.AppModuleBasic{},
			ibcbreakertypes.ModuleName:  ibcbreaker.AppModuleBasic{},
		},
	)
	...
	beginBlockerOrder = append(beginBlockerOrder, optionalRateLimitBeginBlockers()...)
	...
	genesisModuleOrder = append(genesisModuleOrder, optionalRateLimitGenesisModules()...)
...
func (app *EVMD) InitChainer(ctx sdk.Context, req *abci.RequestInitChain) (*abci.ResponseInitChain, error) {
	...
	if err := CrossGenesisValidateAtInitialHeight(app.appCodec, genesisState, req.InitialHeight); err != nil {
		return nil, err
	}
	...
	if err := app.seedMissingSlashingSigningInfos(ctx); err != nil {
		return nil, err
	}
...
func (app *EVMD) seedMissingSlashingSigningInfos(ctx sdk.Context) error {
	var seedErr error
	...
	err := app.StakingKeeper.IterateValidators(ctx, func(_ int64, validator stakingtypes.ValidatorI) bool {
		...
		if _, err := app.SlashingKeeper.GetValidatorSigningInfo(ctx, consAddr); err == nil {
			return false
		}
