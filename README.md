...
Continuum is **forward-compatible** with Ethereum EVM:
...
For a full catalogue of precompiles and detailed semantics, please check the [docs](https://docs.c8ntinuum.com).
...
| `WETH9`                     | Canonical wrapped-native token                      | `0xc8c8fe705d05aa4f115e54d5aa557fdf88888888` | ERC-20 wrapper for the native token, making it usable in existing DeFi tools. |
...
| ------------------ | ------------- |
| **HTTP RPC URL** |  `https://public-evm-rpc.c8ntinuum.com` |
| **WebSocket RPC URL** | `wss://public-evm-rpc.c8ntinuum.com/websocket` |
| **Chain ID** | `2184` |
| **Currency Symbol** | `CTM` |
