...
// NextBlockWithMisbehavior is a helper function that runs the FinalizeBlock
// logic with the provided misbehavior evidence, then commits the resulting
// state changes and updates the network context.
func (n *IntegrationNetwork) NextBlockWithMisbehavior(misbehavior ...abcitypes.Misbehavior) (*abcitypes.ResponseFinalizeBlock, error) {
