...
func currentGenesisParams() types.Params {
	params := types.DefaultParams()
	params.EvmDenom = types.GetEVMCoinDenom()
	params.ExtendedDenomOptions = &types.ExtendedDenomOptions{ExtendedDenom: types.GetEVMCoinExtendedDenom()}
	return params
}
