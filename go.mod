...
require (
	...
	github.com/cosmos/evm/evmd v0.0.0-00010101000000-000000000000
	...
	github.com/softwarecheng/btcd/btcec/v2 v2.3.4
	...
	github.com/vechain/go-ecvrf v0.0.0-20251028092323-35d3b3b039e9
...
require (
	...
	github.com/softwarecheng/btcd/chaincfg/chainhash v1.1.0 // indirect
...
// x/group was split into a sub-module that renamed itself to cosmossdk.io/x/group,
// but at cosmos-sdk v0.53.x it's still part of the main module. Exclude the
// sub-module so Go resolves x/group from the main cosmos-sdk module.
exclude github.com/cosmos/cosmos-sdk/x/group v0.2.0-rc.1
